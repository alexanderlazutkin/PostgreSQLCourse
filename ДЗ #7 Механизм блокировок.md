...
----+-------
 ...
 - Обнаружен deadlock. 
 - Процесс 186 ожидает экскл.блокировку на второй строке и заблокирован процессом 97. Процесс 97 waits for ShareLock on transaction 747; blocked by process 155.
        Процесс 155 wожидает ExclusiveLock на транзакции 748, заблокированной процессом 186.
 Где:       
        Process 186: UPDATE test SET value = value + 10 WHERE id = 2;
        Process 97: UPDATE test SET value = value + 10 WHERE id = 2;
        Process 155: UPDATE test SET value = value + 10 WHERE id = 3;
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA4NzUwMzY3MiwxODczNTM1NTAsLTExND
c2MjQwMTcsNDE5NTkzMzksNzgxNjAwNTkzLC02MjQyMDA1Nzcs
MjIzMTY3MTY4LDE0NjQzMDM4NTFdfQ==
-->