...
Интересный пример приведен тут https://habr.com/ru/company/postgrespro/blog/465263/ , когда одна команда будет обновлять строки в одном порядке, а другая — в другом, они могут взаимозаблокироваться. 
 , но он требует больших знаний и опыта работы с БД чем текущий курс на данном этапе. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MzkwMjkwNjgsMzQ0MTQ0MTI1LC0yMD
