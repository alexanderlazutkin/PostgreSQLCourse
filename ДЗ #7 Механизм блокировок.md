...
|transactionid |          |         | 2936965 | ShareLock        | f| - указывает на то, что блокировка на транзакцию не может быть выполнена, так как в данный момент это поле уже заблокировано другой транзакцией с xid 495. Это транзакция из перовго окна, которая выполняет UPDATE;
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODc2MzcwNzAsLTExNDc2MjQwMTcsND
