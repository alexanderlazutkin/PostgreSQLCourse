...
----+-------
 ...
 - Обнаружен deadlock. Обновление строки 2 в сессии №1 ожидает обновления этой же строки ранее запущенной транзакцией из сессии №2

#### Могут ли две транзакции, выполняющие единственную команду UPDATE одной и той же таблицы (без where), заблокировать друг друга?


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc1MDc3ODA1MywxODczNTM1NTAsLTExND
