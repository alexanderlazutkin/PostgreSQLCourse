...
завершить первую транзакцию - commit;
сделать select * from persons во второй сессии
видите ли вы новую запись и если да то почему?  -- ***Да. Транзакция завершилась. Запись добавлена, т.к. неповторяющееся чтение допускается стандартом только на уровнях Read Uncommitted и Read Committed***
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5Mzc3MjYyNTBdfQ==
-->